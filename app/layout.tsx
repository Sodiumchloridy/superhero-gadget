      ...
      <body>
        ...
        <h6>Follow Us On</h6>
          <div className='grid-container'>
            {/* Facebook */}
            <a className='social' href='https://www.facebook.com/superherogadgetmalaysia/' target="_blank" rel="noopener noreferrer">
            ...
            {/* Instagram */}
            <a className='social' href='https://www.instagram.com/superherogadget_c180/' target="_blank" rel="noopener noreferrer">
